...
| 状态 | 描述 |
| :--- | :--- |
| ![Active](https://img.shields.io/badge/Status-Active-brightgreen) | 积极维护中，功能完整。 |
| ![Stale](https://img.shields.io/badge/Status-Stale-yellow) | 维护放缓，但仍具参考价值。 |
| ![Dead](https://img.shields.io/badge/Status-Dead-red) | 已停止维护，不建议使用。 |
| ![Free](https://img.shields.io/badge/Price-Free-green) | **完全免费**：开源项目或免费工具。 |
| ![Freemium](https://img.shields.io/badge/Price-Freemium-orange) | **部分付费**：基础功能免费，部分功能需要付费或者订阅。 |
| ![Paid](https://img.shields.io/badge/Price-Paid-blueviolet) | **商业付费**：需购买授权或支付订阅费用才能使用。 |
...
- 2026-01-23：更新所有 item 的维护状态、优化表格展示
